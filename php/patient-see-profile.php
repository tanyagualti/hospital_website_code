        ...
        <div class="card mb-3" style="border-radius: .5rem;box-shadow: 0px 0px 10px black;">
          <div class="row g-0">
            <div class="col-md-4 gradient-custom text-center text-white"
              ...
              <img src="../upload-images/<?php echo $rows['p_url'];?>"
                alt="Avatar" class="img-fluid my-5" style="width: 80px;" />
              <h5 ><?php echo $rows['p_name'];?></h5>
              <p >Age:<?php echo $rows['age'];?></p>
                 <p >Height<?php echo $rows['height'];?></p>
                 <p >Weight:<?php echo $rows['weight'];?></p>
              ...
              <div class="card-body p-4">
                ...
                <div class="row pt-1">
                  <div class="col-6 mb-3">
                    <h6>Email</h6>
                    <p class="text-muted"><?php echo $rows['p_email'];?></p>
                  </div>
                  <div class="col-6 mb-3">
                    <h6>Phone</h6>
                ...
                <div class="row pt-1">
                  ...
                  <div class="col-6 mb-3">
                    <h6>Problem</h6>
                    <p class="text-muted"><?php echo $rows['problem'];?></p>
                  </div>
                </div>
