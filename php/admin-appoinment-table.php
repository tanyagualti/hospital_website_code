...
<div class="table-box" style="overflow-x:scroll;" >
    <table >
        <thead>
           <th style="color:white;letter-spacing: 2px;padding-right: 20px;">Doctor Name</th>
            <th style="color:white;letter-spacing: 2px;">Name</th>
            <th style="color:white;letter-spacing: 2px;">Email</th>
            <th style="color:white;letter-spacing: 2px;padding-right: 10px;">Qualification</th>
...
$sql = "SELECT * FROM appointment INNER JOIN doc ON appointment.doctor = doc.d_id";
            ...
            ?>
                        ...
                        <tr>
                              <td style="color:white;letter-spacing: 2px;"><?php echo $rows['d_name']; ?></td>
                            ...
                            <td>
                                <a class="btn btn-light" style="padding:7px" href="delete-appoinment.php?id=<?php echo $rows['id'];?>">Delete</a>
                            </td>
                        </tr>
