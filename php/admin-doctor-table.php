        ...
        <tbody>
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td style="color:white;letter-spacing: 2px;"><?php echo $rows['d_email']; ?></td>
                            <td style="color:white;letter-spacing: 2px;"><?php echo $rows['qualification']; ?></td>
                            <td style="color:white;letter-spacing: 2px;"><?php echo $rows['contact']; ?></td>
                            <td>
                                <a class="btn btn-light" style="padding:7px" href="delete-doctor.php?id=<?php echo $rows['d_id'];?>">Delete</a>
                            </td>
                        </tr>
