...
<div class="col-md-4" style="position:absolute;top:60%;left: 50%;transform: translate(-50%,-50%);">
   ...
   <div style="background: linear-gradient(to right, #1d86df 0%, #39b49a 100%);"class="pricing-table-header grd1">
    <h2 style="text-align: center;">Patients DashBoard</h2>
   ...
   <div style="margin:0px;"class="pricing-table-features">
    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
      ...
      <span class= "material-symbols-outlined" id="ic"> person</span>
       <input required class="input" style=" width: 100%;" type="text" name="name" placeholder="patient_name">
...
$sql="select p_id,p_name,p_password from patient where p_name='$name' and p_password='$password'";
    ...
    if($result=mysqli_query($conn,$sql)){
        ...
        while($rows=mysqli_fetch_assoc($result)){
            $_SESSION['id']=$rows['p_id'];
             $_SESSION['name']=$rows['p_name'];

             ?>
             <script type="text/javascript">
                 
                 window.location.href='http://localhost/hospital/lifecare/php/patient-login-insert.php';
             </script>
